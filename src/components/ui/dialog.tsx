...
function DialogContent({ ref, children, className, ...props }: React.ComponentPropsWithoutRef<typeof DialogPrimitive.Content> & { ref?: React.RefObject<React.ElementRef<typeof DialogPrimitive.Content> | null> }) {
  return (
    <DialogPortal>
      <DialogOverlay />
