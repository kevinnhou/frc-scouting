...
function SheetContent({ ref, children, className, side = "right", ...props }: SheetContentProps & { ref?: React.RefObject<React.ElementRef<typeof SheetPrimitive.Content> | null> }) {
  return (
    <SheetPortal>
      <SheetOverlay />
